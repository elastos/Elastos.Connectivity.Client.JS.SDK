import type { DIDAccess } from "../did";
...
export class AuthHelper {
  ...
  */
  /* TODO RESTORE WHEN HIVE JS IS READY public handleVaultAuthenticationChallenge(jwtToken: string): Promise<string> {
   ...
   */
  /* TODO RESTORE WHEN HIVE JS IS READY
